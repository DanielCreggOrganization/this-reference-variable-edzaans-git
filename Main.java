...
public class Main {
    public static void main(String[] args) {
        ...
        Date dateObject2 = new Date(20, 02, 2020);
        // Call the printDate() method for each object you create.
        System.out.println("Today is Thursday :" +dateObject2.year+"/"+dateObject2.month+"/"+dateObject2.day);
        ...
        Date dateObject5 = new Date(17, 03, 2020, "St Patyricks Day");
